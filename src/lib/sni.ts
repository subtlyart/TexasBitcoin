...
export const sniSources: SniSource[] = [
  ...
  { id: 6, label: "SNI - Daniel Krawisz, author page: thirty-four Mempool entries, from the Crypto-Anarchy and Libertarian Entrepreneurship chapters (May 2013) and Hyperbitcoinization (March 29, 2014) to Crashes and Hyperinflation (January 8, 2017)", url: "https://nakamotoinstitute.org/authors/daniel-krawisz/" },
  ...
  { id: 8, label: "SNI - The Memory Pool: 76 essays counted September 2026, from Rochard's December 2012 pieces through Parker Lewis's sixteen-part Gradually, Then Suddenly (2019–2020), Ross Ulbricht's Bitcoin Equals Freedom (2019), Gigi's Bitcoin is Time (January 14, 2021), and Goldstein (2022–2023)", url: "https://nakamotoinstitute.org/mempool/" },
...
export const sniTimeline: SniEvent[] = [
  ...
  },
  {
    ...
    detail:
      "Now a Bitcoin SV advocate, Krawisz tells CoinGeek: \"I lost the allies with whom I started the Satoshi Nakamoto Institute because they bought into 'core' ideas,\" and \"it was a mistake to make a think tank that was not also a mining pool.\" The Institute keeps every one of his thirty-four essays online.",
    kind: "schism",
    sourceIds: [13, 6],
  },
  {
    ...
    detail:
      "Through the quiet years the Mempool stays the place serious essays go: all sixteen parts of Parker Lewis's \"Gradually, Then Suddenly\" (2019–2020) - \"Bitcoin Cannot Be Banned,\" \"Bitcoin is Common Sense,\" \"Bitcoin is the Great Definancialization\" - Ross Ulbricht's \"Bitcoin Equals Freedom\" (2019), Gigi's \"Bitcoin is Time\" (January 14, 2021), then Goldstein's own return with \"Toward a Node World Order\" (2022) and \"Everyone's a Speculator\" (2023).",
    kind: "canon",
    sourceIds: [8, 7],
  },
  {
